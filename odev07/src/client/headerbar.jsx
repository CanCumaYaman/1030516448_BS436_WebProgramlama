        ...
        return (
            <React.Fragment>
                ...
                <div className="action-buttons">
                    <Link className="header-button " to="/login" tabIndex="0" style={{color: "blue",textDecoration:"none",marginRight:"5px"}}>
                        Giriş Yap
                    </Link>
                    <Link className="header-button" to="/signup" tabIndex="0" style={{color: "blue",textDecoration:"none"}}>
                        Üye Ol
                    </Link>
                </div>
            </React.Fragment>
